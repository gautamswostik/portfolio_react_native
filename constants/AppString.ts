export class AppString {
    ...
    static yellowNepalWorkOne: String = "Migrated an Ionic project (a mobile app for warehouse management) from ionic to flutter,which was a huge breaking change."
    static yellowNepalWorkTwo: String = "Worked on designing e-commerce application"
    static yellowNepalWorkThree: String = "Worked on testing an application"
    static yellowNepalWorkFour: String = "Worked on communication skill with national and international clients"
} 